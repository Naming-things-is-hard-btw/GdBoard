...
func _ready():
	...
	panel.add_theme_stylebox_override("panel", preload("res://Plugins/paint2D/src/new/frame/framegrid.tres"))
	pass
...
func new_image(_color = Color(0,0,0,0), force_new : bool = false, idx = -1):
	...
	if not node or force_new:
		node = preload("res://Plugins/paint2D/src/new/draw_image/image.scn").instantiate()
