...
func Update():
	...
	for i in range(layers.size()):
		...
		if a is DrawingImage:
			...
			if a.visible:
				item.add_button(0, preload("res://Plugins/paint2D/res/visible.png"))
			else:
				item.add_button(0, preload("res://Plugins/paint2D/res/notvisible.png"))
			item.add_button(2, preload("res://Plugins/paint2D/res/up.png"))
			item.add_button(3, preload("res://Plugins/paint2D/res/down.png"))
			pass
		pass
